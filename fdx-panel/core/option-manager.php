...
class option {
    ...
    public static function getOptions() {
        $themeOptions = include(FDX_PANEL . "/options_theme_fix.php");
        $fdxOptions = include(FDX_PANEL . "/options.php");

        self::$evoOptions = array_merge_recursive($themeOptions, $fdxOptions);
